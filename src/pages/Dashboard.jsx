...
export default function Dashboard() {
  ...
  const updatedTest = test.map((item) => {
    const apiData = dashboard.totalYear
      ? dashboard.totalYear.find((data) => data.name === item.num)
      : null;
        ...
        <Content>
          <div className="row mt-3">
            ...
            <div className="col-md-12">
              <div className="my-2">
                <div className="d-flex flex-row flex-end justify-content-end">
                <Calenda/>
                </div>
                <div className="row">
                  <div className="">
                    <div className="card-body">
                      ...
                      <div className="row mt-4">
                        <div className="col-md-8">
                          <div className="card border-1">
                            <div className="fw-bold ms-4 h5 mt-4">
                              การปล่อยก๊าซเรือนกระจกและดูดกลับ{" "}
                              {selectedYear + 543}
                            </div>
                            <div className="card-body">
                              <div className="row">
                        ...
                        <div className="col-md-4">
                          <div className="card border-1">
                            <div className="fw-bold mt-4 h5 ms-4">
                              รูปแบบการจัดเก็บข้อมูล ปี {selectedYear + 543}
                            </div>
                            <div className="card-body">
              ...
              <div className="row mt-3">
                <div className="col-md-3 mb-4">
                  <div className="card border-1 h-100 text-center">
                    <p className="p-4 fw-bold">Scope 1</p>
                    <div
                      style={{
                        display: "flex",
                ...
                <div className="col-md-3 mb-4">
                  <div className="card border-1 h-100 text-center">
                    <p className="p-4 fw-bold">Scope 2</p>
                    <div
                      style={{
                        display: "flex",
                        justifyContent: "center",
                ...
                <div className="col-md-3 mb-4">
                  <div className="card border-1 h-100 text-center">
                    <p className="p-4 fw-bold">Scope 3</p>
                    <div
                      style={{
                        display: "flex",
                        justifyContent: "center",
                ...
                <div className="col-md-3 mb-4">
                  <div className="card border-1 h-100 text-center">
                    <p className="p-4 fw-bold">Scope Ratio</p>
                    <div
                      style={{
                        display: "flex",
                        justifyContent: "center",
