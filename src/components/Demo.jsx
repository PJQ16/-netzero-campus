...
function Demo() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        config.urlApi + "/users/showUserApi",
        config.headers()
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        config.urlApi + `/createAcivity/addPeriod`,
        payload
      );
      setCampusReport("");
      setSearchYear("");
  ...
  return (
    <div className="body-wrapper">
                ...
                <div className="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop mdc-layout-grid__cell--span-12-tablet">
                  <div className="mdc-card info-card info-card--light">
                    <div className="card-inner">
                      ...
                      <h5
                        className="font-weight-light pb-2 mb-1 border-bottom"
                        style={{
                          fontSize: "30px",
                          fontWeight: "500",
                          color: "#1E8A87",
                ...
                <div className="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                  <div className="mdc-card">
                    <div className="d-flex flex-row justify-content-between align-items-center">
                      <h6 className="card-title mb-2 mb-sm-0">
                      ...
                      >
                        <LibraryAddIcon />{" "}
                        สร้างกิจกรรมการปล่อยและการดูดกลับก๊าซเรือนกระจก
                      </button>
                    </div>
      ...
      <Modal
        title="สร้างกิจกรรมการปล่อยและการดูดกลับก๊าซเรือนกระจก"
        id="ModalAddActivity"
      >
        <form onSubmit={handleSubmit}>
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              />
              {errors.campusReport && (
                <div className="text-danger">{errors.campusReport}</div>
              )}
            </div>
          </div>
